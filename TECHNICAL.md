...
**Settings modal** — Gear icon in the sidebar footer (desktop) or topbar (tablet). Controls pricing mode and grouped layout. Switching to full pricing mode shows a warning about API rate limits.
